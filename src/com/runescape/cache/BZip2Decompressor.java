...
final public class BZip2Decompressor {

	public static int decompress(byte abyte0[], int i, byte abyte1[], int j, int k) {
		synchronized (bzipState) {
			bzipState.aByteArray563 = abyte1;
			bzipState.anInt564 = k;
			bzipState.aByteArray568 = abyte0;
			bzipState.anInt569 = 0;
			bzipState.anInt565 = j;
			bzipState.anInt570 = i;
			bzipState.anInt577 = 0;
			bzipState.anInt576 = 0;
			bzipState.anInt566 = 0;
			bzipState.anInt567 = 0;
			bzipState.anInt571 = 0;
			bzipState.anInt572 = 0;
			bzipState.anInt579 = 0;
			method227(bzipState);
			i -= bzipState.anInt570;
			return i;
		}
	}
	...
	private static final BZip2DecompressionState bzipState = new BZip2DecompressionState();
