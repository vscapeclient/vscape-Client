...
final public class MapRegion {
				...
				for (int l6 = -5; l6 < anInt146 + 5; l6++) {
					...
					if (l6 >= 1 && l6 < anInt146 - 1) {
						...
						for (int k17 = -5; k17 < anInt147 + 5; k17++) {
							...
							if (k17 >= 1 && k17 < anInt147 - 1 && (!lowMem || (tileFlags[0][l6][k17] & 2) != 0 || (tileFlags[l][l6][k17] & 0x10) == 0 && method182(k17, l, l6) == currentPlane)) {
								if (l < maximumPlane)
									maximumPlane = l;
								...
								if (l18 > 0 || i19 > 0) {
									...
									if (l > 0) {
										...
										if (l18 == 0 && aByteArrayArrayArray136[l][l6][k17] != 0)
											flag = false;
										if (i19 > 0 && !FloOverlay.cache[i19 - 1].occlude)
											flag = false;
									...
									if (i19 == 0) {
										...
										FloOverlay overlay_flo = FloOverlay.cache[i19 - 1];
										...
										if (textureId >= 0) {
		                                    minimapColor = Texture.method369(textureId);
		                                    j23 = -1;
		                                    ...
		                                    minimapColor = Texture.anIntArray1482[method185(overlay_flo.hslToRgb, 96)];                                
		                                    j23 = -2;
		                                    textureId = -1;
		                                } else {
		                                    j23 = method177(overlay_flo.hue, overlay_flo.saturation, overlay_flo.lumiance);
		                                    minimapColor = Texture.anIntArray1482[method185(overlay_flo.hslToRgb, 96)];
		                                }
										if (minimapColor == 0x000000 && overlay_flo.anotherRgb != -1) {
											int newMinimapColor = method177(overlay_flo.secondaryHue, overlay_flo.secondarySaturation, overlay_flo.secondaryLuminance);
	                                        minimapColor = Texture.anIntArray1482[method185(newMinimapColor, 96)];
										}
	...
	private void method175(int i, WorldController worldController, CollisionMap class11, int j, int k, int l, int i1, int j1) {
		...
		if (j == 22) {
			...
			if (class46.animation == -1 && class46.childrenIDs == null)
				...
				obj = new RenderableObject(i1, j1, 22, l1, i2, k1, j2, class46.animation, true);
		...
		if (j == 10 || j == 11) {
			...
			if (class46.animation == -1 && class46.childrenIDs == null)
				...
				obj1 = new RenderableObject(i1, j1, 10, l1, i2, k1, j2, class46.animation, true);
			if (obj1 != null) {
				int i5 = 0;
				if (j == 11)
					i5 += 256;
		...
		if (j >= 12) {
			...
			if (class46.animation == -1 && class46.childrenIDs == null)
				...
				obj2 = new RenderableObject(i1, j1, j, l1, i2, k1, j2, class46.animation, true);
		...
		if (j == 0) {
			...
			if (class46.animation == -1 && class46.childrenIDs == null)
				...
				obj3 = new RenderableObject(i1, j1, 0, l1, i2, k1, j2, class46.animation, true);
		...
		if (j == 1) {
			...
			if (class46.animation == -1 && class46.childrenIDs == null)
				...
				obj4 = new RenderableObject(i1, j1, 1, l1, i2, k1, j2, class46.animation, true);
		...
		if (j == 2) {
			...
			if (class46.animation == -1 && class46.childrenIDs == null) {
				...
				obj11 = new RenderableObject(i1, 4 + j1, 2, l1, i2, k1, j2, class46.animation, true);
				obj12 = new RenderableObject(i1, i3, 2, l1, i2, k1, j2, class46.animation, true);
			}
		...
		if (j == 3) {
			...
			if (class46.animation == -1 && class46.childrenIDs == null)
				...
				obj5 = new RenderableObject(i1, j1, 3, l1, i2, k1, j2, class46.animation, true);
		...
		if (j == 9) {
			...
			if (class46.animation == -1 && class46.childrenIDs == null)
				...
				obj6 = new RenderableObject(i1, j1, j, l1, i2, k1, j2, class46.animation, true);
		...
		if (j == 4) {
			...
			if (class46.animation == -1 && class46.childrenIDs == null)
				...
				obj7 = new RenderableObject(i1, 0, 4, l1, i2, k1, j2, class46.animation, true);
		...
		if (j == 5) {
			...
			if (k4 > 0) {
				ObjectDef class46_1 = ObjectDef.forID(k4 >> 14 & 0x7fff);
				if(class46_1 != null)
					i4 = class46_1.decorDisplacement;
			}
			Object obj13;
			if (class46.animation == -1 && class46.childrenIDs == null)
				obj13 = class46.method578(4, 0, k1, l1, i2, j2, -1);
			else
				obj13 = new RenderableObject(i1, 0, 4, l1, i2, k1, j2, class46.animation, true);
		...
		if (j == 6) {
			...
			if (class46.animation == -1 && class46.childrenIDs == null)
				...
				obj8 = new RenderableObject(i1, 0, 4, l1, i2, k1, j2, class46.animation, true);
		...
		if (j == 7) {
			...
			if (class46.animation == -1 && class46.childrenIDs == null)
				...
				obj9 = new RenderableObject(i1, 0, 4, l1, i2, k1, j2, class46.animation, true);
		...
		if (j == 8) {
			...
			if (class46.animation == -1 && class46.childrenIDs == null)
				...
				obj10 = new RenderableObject(i1, 0, 4, l1, i2, k1, j2, class46.animation, true);
	...
	public final void loadCopyMapChunk(int tileZ, int tileRot, CollisionMap[] collisionMaps, int baseDestX, int baseTileX, byte[] floorMap, int baseTileY, int mapZ, int baseDestY) {
		for (int i2 = 0; i2 < 8; i2++) {
			for (int j2 = 0; j2 < 8; j2++)
				if (baseDestX + i2 > 0 && baseDestX + i2 < 103 && baseDestY + j2 > 0 && baseDestY + j2 < 103)
					collisionMaps[mapZ].anIntArrayArray294[baseDestX + i2][baseDestY + j2] &= 0xfeffffff;

		}
		Stream floorMapStream = new Stream(floorMap);
		for (int z = 0; z < 4; z++) {
			for (int x = 0; x < 64; x++) {
				for (int y = 0; y < 64; y++)
					if (z == tileZ && x >= baseTileX && x < baseTileX + 8 && y >= baseTileY && y < baseTileY + 8)
						loadMapTile(baseDestY + TileUtils.getRotatedYCoord(tileRot, x & 7, y & 7), 0, floorMapStream, baseDestX + TileUtils.getRotatedXCoord(tileRot, x & 7, y & 7), mapZ, tileRot, 0);
					else
						loadMapTile(-1, 0, floorMapStream, -1, 0, 0, 0);
			}
		}
	}

	public final void loadMapChunk(byte[] floorMap, int i, int j, int k, int l, CollisionMap[] collisionMaps) {
		for (int i1 = 0; i1 < 4; i1++) {
			for (int j1 = 0; j1 < 64; j1++) {
				for (int k1 = 0; k1 < 64; k1++)
					if (j + j1 > 0 && j + j1 < 103 && i + k1 > 0 && i + k1 < 103)
						collisionMaps[i1].anIntArrayArray294[j + j1][i + k1] &= 0xfeffffff;
		...
		for (int l1 = 0; l1 < 4; l1++) {
			for (int i2 = 0; i2 < 64; i2++) {
				for (int j2 = 0; j2 < 64; j2++) {
					loadMapTile(j2 + i, l, floorMapStream, i2 + j, l1, 0, k);
				}
			}
		}
	}

	private void loadMapTile(int y, int regionX, Stream floorMapStream, int x, int plane, int rotation, int regionY) {
		try {
			if (x >= 0 && x < 104 && y >= 0 && y < 104) {
				tileFlags[plane][x][y] = 0;
				do {
					int l1 = floorMapStream.readUnsignedByte();
					if (l1 == 0)
						if (plane == 0) {
							tileHeights[0][x][y] = -method172(0xe3b7b + x + regionY, 0x87cce + y + regionX) * 8;
							return;
						} else {
					...
					if (l1 == 1) {
						int j2 = floorMapStream.readUnsignedByte();
						if (j2 == 1)
							j2 = 0;
						if (plane == 0) {
							tileHeights[0][x][y] = -j2 * 8;
							return;
						} else {
							tileHeights[plane][x][y] = tileHeights[plane - 1][x][y] - j2 * 8;
							return;
						}
					}
					if (l1 <= 49) {
						aByteArrayArrayArray130[plane][x][y] = floorMapStream.readSignedByte();
						aByteArrayArrayArray136[plane][x][y] = (byte) ((l1 - 2) / 4);
						aByteArrayArrayArray148[plane][x][y] = (byte) ((l1 - 2) + rotation & 3);
					} else if (l1 <= 81) {
						tileFlags[plane][x][y] = (byte) (l1 - 49);
					}
					else {
						aByteArrayArrayArray142[plane][x][y] = (byte) (l1 - 81);
					}
				} while (true);
				
			}
			do {
				int i2 = floorMapStream.readUnsignedByte();
				if (i2 == 0)
					break;
				if (i2 == 1) {
					floorMapStream.readUnsignedByte();
					return;
				}
				if (i2 <= 49)
					floorMapStream.readUnsignedByte();
	...
	public final void method183(CollisionMap aclass11[], WorldController worldController, int z, int j, int k, int plane, byte abyte0[], int i1, int rotation, int k1) {
		label0: {
			...
			do {
				...
				do {
					...
					int objFace = objectData & 3;
					if (height == z && localX >= i1 && localX < i1 + 8 && localY >= k && localY < k + 8) {
						ObjectDef class46 = ObjectDef.forID(l1);
						if(class46 == null) continue;
						int newX = j + TileUtils.getNewXCoord(rotation, (objFace == 0 || objFace == 2) ? class46.length : class46.width, localX & 7, localY & 7, (objFace == 0 || objFace == 2) ? class46.width : class46.length);
						int newY = k1 + TileUtils.getNewYCoord(localY & 7, (objFace == 0 || objFace == 2) ? class46.length : class46.width, rotation, (objFace == 0 || objFace == 2) ? class46.width : class46.length, localX & 7);
						if (newX > 0 && newY > 0 && newX < 103 && newY < 103) {
							int l4 = height;
							if ((tileFlags[1][newX][newY] & 2) == 2)
								l4--;
							CollisionMap class11 = null;
							if (l4 >= 0)
								class11 = aclass11[plane];
							method175(newY, worldController, class11, type, plane, newX, l1, objFace + rotation & 3);
						}
					}
				} while (true);
			} while (true);
	...
	public static void method188(WorldController worldController, int i, int j, int k, int l, CollisionMap class11, int ai[][][], int i1, int j1, int k1) {
		...
		if (k == 5) {
			...
			if (l4 > 0) {
				ObjectDef class46_1 = ObjectDef.forID(l4 >> 14 & 0x7fff);
				if(class46_1 != null)
					j4 = class46_1.decorDisplacement;
			}
			Object obj13;
			if (class46.animation == -1 && class46.childrenIDs == null)
