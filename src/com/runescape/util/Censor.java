...
final public class Censor {

	public static void loadConfig(Archive streamLoader)
	{
		Stream stream = new Stream(streamLoader.getFile("fragmentsenc.txt"));
		Stream stream_1 = new Stream(streamLoader.getFile("badenc.txt"));
		Stream stream_2 = new Stream(streamLoader.getFile("domainenc.txt"));
		Stream stream_3 = new Stream(streamLoader.getFile("tldlist.txt"));
