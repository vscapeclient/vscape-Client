...
public class CacheDownloader {
         ...
         *
         */
        private static final String cacheURL = "http://vidyascape.org/files/cache/";
        ...
        private static String getCacheLink() {
        	return cacheURL + (ClientSettings.CACHE_DEV_BRANCH ? "dev.zip" : "live.zip");
        }
        
        private static String getVersionLink() {
        	return cacheURL + (ClientSettings.CACHE_DEV_BRANCH ? "versionDev.dat" : "versionLive.dat");
        }

        public int getCacheRemoteVersion() throws IOException {
        ...
        public int getCacheLocalVersion() throws IOException {
        ...
        private void downloadFile(String adress, String localFileName) {
                ...
                try {
                       ...
                       // System.out.println(localFileName + "\t" + numWritten);
                        ...
                        drawLoadingText("Finished downloading cache!");
